...
import com.lebang.mysource.Common.Logger;
import com.lebang.mysource.presentation.DemoPresentation;
...
public class SourceActivity extends Activity {
    ...
    private void connect(UsbAccessory accessory) {
        ...
        startServices();//TODO LeBang really thing
    ...
    class Presenter implements DisplaySourceService.Callbacks {//TODO Presenter 就是Callback,机智
